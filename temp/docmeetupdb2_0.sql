...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 04:09 PM
...
ALTER TABLE `medication`
  ...
  ADD KEY `medication_ibfk_1` (`pharmacy_id`);
...
--
-- AUTO_INCREMENT for table `insurancefile`
--
ALTER TABLE `insurancefile`
...
--
ALTER TABLE `eventattendance`
  ADD CONSTRAINT `eventattendance_ibfk_1` FOREIGN KEY (`attendee_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `eventattendance_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `event` (`event_id`);
...
--
ALTER TABLE `insurancefile`
  ADD CONSTRAINT `insurancefile_ibfk_1` FOREIGN KEY (`file_id`) REFERENCES `medicalfile` (`file_id`),
  ADD CONSTRAINT `insurancefile_ibfk_2` FOREIGN KEY (`insurance_id`) REFERENCES `user` (`user_id`),
  ADD CONSTRAINT `insurancefile_ibfk_3` FOREIGN KEY (`patient_id`) REFERENCES `user` (`user_id`);
...
--
ALTER TABLE `medication`
  ADD CONSTRAINT `medication_ibfk_1` FOREIGN KEY (`pharmacy_id`) REFERENCES `user` (`user_id`);
...
--
ALTER TABLE `prescriptionanalysis`
  ADD CONSTRAINT `prescriptionanalysis_ibfk_1` FOREIGN KEY (`analysis_id`) REFERENCES `analysis` (`analysis_id`),
  ADD CONSTRAINT `prescriptionanalysis_ibfk_2` FOREIGN KEY (`prescription_id`) REFERENCES `prescription` (`prescription_id`);

--
-- Constraints for table `prescriptionmedication`
--
ALTER TABLE `prescriptionmedication`
  ADD CONSTRAINT `prescriptionmedication_ibfk_1` FOREIGN KEY (`medication_id`) REFERENCES `medication` (`medication_id`),
  ADD CONSTRAINT `prescriptionmedication_ibfk_2` FOREIGN KEY (`prescription_id`) REFERENCES `prescription` (`prescription_id`);
COMMIT;
